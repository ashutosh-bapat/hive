...
public class ObjectStore implements RawStore, Configurable {
  ...
  */
  ...
  public void createTable(Table tbl) throws InvalidObjectException, MetaException {
    ...
    // TODO: should we update the statistics within the above transaction itself?
  ...
  public Table getTable(String catName, String dbName, String tableName, String writeIdList,
    ...
    // Get the statistics if requested. TODO: We should find a way to do this in one shot through
    // getMTable.
    // Should we do this under the same transaction as above?
    try {
      if (getColumnStats) {
        // TODO: Should we consider checking tbl.setIsStatsCompliant() here?
